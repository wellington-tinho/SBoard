var fe=Object.defineProperty,ye=Object.defineProperties;var xe=Object.getOwnPropertyDescriptors;var ae=Object.getOwnPropertySymbols;var we=Object.prototype.hasOwnProperty,Ce=Object.prototype.propertyIsEnumerable;var ne=(a,d,r)=>d in a?fe(a,d,{enumerable:!0,configurable:!0,writable:!0,value:r}):a[d]=r,_=(a,d)=>{for(var r in d||(d={}))we.call(d,r)&&ne(a,r,d[r]);if(ae)for(var r of ae(d))Ce.call(d,r)&&ne(a,r,d[r]);return a},K=(a,d)=>ye(a,xe(d));import{s as z,j as t,a as e,r as n,T as oe,b as de,c as P,d as W,M as L,V,t as U,F as le,e as Se,C as Ee,f as Ne,g as se,u as ke,A as Re,h as Ie,B as Me,i as $e,H as De,R as Fe,k as Ae,l as ze,m as Te,W as Oe,n as _e,o as qe,p as Le}from"./vendor.f860924a.js";const je=function(){const d=document.createElement("link").relList;if(d&&d.supports&&d.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))i(c);new MutationObserver(c=>{for(const l of c)if(l.type==="childList")for(const g of l.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&i(g)}).observe(document,{childList:!0,subtree:!0});function r(c){const l={};return c.integrity&&(l.integrity=c.integrity),c.referrerpolicy&&(l.referrerPolicy=c.referrerpolicy),c.crossorigin==="use-credentials"?l.credentials="include":c.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function i(c){if(c.ep)return;c.ep=!0;const l=r(c);fetch(c.href,l)}};je();var Be="/assets/Logo.fe6b5af1.png";const Ve=z.header`
...
`;function vt({isOpen:a,onRequestClose:d,edges:r}){const[i]=n.exports.useContext(j),[c,l]=n.exports.useState(String),[g,m]=n.exports.useState(String),[y,f]=n.exports.useState(),[v,x]=n.exports.useState(),[s,C]=n.exports.useState(),[E,N]=n.exports.useState(),[b,k]=n.exports.useState(),[R,M]=n.exports.useState(),[$,D]=n.exports.useState();function I(h){h.preventDefault();for(var w=1;w<r.length;w++){var o=B(v,s),u=B(E,b),p=B(R,$);i.$(`#${r[w]}`).data("negative",y||i.$(`#${r[w]}`).data("negative")).data("weight",o||i.$(`#${r[w]}`).data("weight")).data("reliability",u||i.$(`#${r[w]}`).data("reliability")).data("delay",p||i.$(`#${r[w]}`).data("delay"))}U.success("Edges modified with success!")}return e(L,{isOpen:a,onRequestClose:d,overlayClassName:"react-modal-overlay",className:"react-modal-content",children:t(bt,{onSubmit:I,children:[e(V,{onClick:d,className:"react-modal-close"}),e("h2",{children:"Change Edges selectd"}),t("div",{children:[t("div",{children:[e("p",{children:"source"}),e("input",{onChange:h=>l(h.target.value),type:"string",name:"Country",id:"Country",placeholder:"Insira aqui um valor para alterar",disabled:!0})]}),t("div",{children:[e("p",{children:"target"}),e("input",{onChange:h=>m(h.target.value),type:"string",name:"domain",id:"domain",placeholder:"Insira aqui um valor para alterar",disabled:!0})]}),t("div",{children:[e("p",{children:"negative"}),e("input",{onChange:h=>f(Number(h.target.value)),type:"number",name:"label",id:"label",placeholder:"Insira aqui um valor para alterar."})]}),t("div",{children:[e("p",{children:"Bandwidth"}),t("div",{className:"tooltip",children:[e("input",{onChange:h=>{h.target.value===""?x(void 0):x(Number(h.target.value))},max:s,type:"number",name:"weightStart",id:"weightStart",placeholder:"Insira aqui um valor para alterar."}),e("input",{onChange:h=>{h.target.value===""?C(void 0):C(Number(h.target.value))},min:v,type:"number",name:"weightEnd",id:"weightEnd",placeholder:"Insira aqui um valor para alterar."}),e("span",{className:"tooltiptext",children:"Insert a number from start to end, to generate a random number between them."})]})]}),t("div",{children:[e("p",{children:"Reliability"}),t("div",{className:"tooltip",children:[e("input",{onChange:h=>{h.target.value===""?N(void 0):N(Number(h.target.value))},max:b,type:"number",name:"ReliabilityStart",id:"RealityStart",placeholder:"Insira aqui um valor para alterar."}),e("input",{onChange:h=>{h.target.value===""?k(void 0):k(Number(h.target.value))},min:E,type:"number",name:"ReliabilityEnd",id:"RealityEnd",placeholder:"Insira aqui um valor para alterar."}),e("span",{className:"tooltiptext",children:"Insert a number from start to end, to generate a random number between them."})]})]}),t("div",{children:[e("p",{children:"Delay"}),t("div",{className:"tooltip",children:[e("input",{onChange:h=>{h.target.value===""?M(void 0):M(Number(h.target.value))},max:$,type:"number",name:"DelayStart",id:"DelayStart",placeholder:"Insira aqui um valor para alterar."}),e("input",{onChange:h=>{D(Number(h.target.value))},min:R,type:"number",name:"DelayEnd",id:"DelayEnd",placeholder:"Insira aqui um valor para alterar."}),e("span",{className:"tooltiptext",children:"Insert a number from start to end, to generate a random number between them."})]})]}),e("button",{type:"submit",children:"Salvar altera\xE7\xF5es"})]})]})})}const ft=z.form`
...
`;function yt({isOpen:a,onRequestClose:d,nodes:r}){const[i]=n.exports.useContext(j),[c,l]=n.exports.useState(String),[g,m]=n.exports.useState(String),[y,f]=n.exports.useState(String),[v,x]=n.exports.useState(String),[s,C]=n.exports.useState(),[E,N]=n.exports.useState(),[b,k]=n.exports.useState(),[R,M]=n.exports.useState(),[$,D]=n.exports.useState(),[I,h]=n.exports.useState();function w(o){o.preventDefault();for(var u=1;u<r.length;u++){var p=B($,I);i.$(`#${r[u]}`).data("Country",c||i.$(`#${r[u]}`).data("Country")).data("domain",E||i.$(`#${r[u]}`).data("domain")).data("label",g||i.$(`#${r[u]}`).data("label")).data("name",y||i.$(`#${r[u]}`).data("name")).data("region",s||i.$(`#${r[u]}`).data("region")).data("type",v||i.$(`#${r[u]}`).data("type")).data("value",b||i.$(`#${r[u]}`).data("value")).data("pos",R||i.$(`#${r[u]}`).data("pos")).data("weight",p||i.$(`#${r[u]}`).data("weight"))}U.success("Nodes modified with success!")}return e(L,{isOpen:a,onRequestClose:d,overlayClassName:"react-modal-overlay",className:"react-modal-content",children:t(ft,{onSubmit:w,children:[e(V,{onClick:d,className:"react-modal-close"}),e("h2",{children:"Change Nodes selectd"}),t("div",{children:[t("div",{children:[e("p",{children:"Country"}),e("input",{onChange:o=>l(o.target.value),type:"string",name:"country",id:"country",placeholder:"Insira aqui um valor para alterar"})]}),t("div",{children:[e("p",{children:"domain"}),e("input",{onChange:o=>N(Number(o.target.value)),type:"string",name:"domain",id:"domain",placeholder:"Insira aqui um valor para alterar"})]}),t("div",{children:[e("p",{children:"label"}),e("input",{onChange:o=>m(o.target.value),type:"string",name:"label",id:"label",placeholder:"Insira aqui um valor para alterar"})]}),t("div",{children:[e("p",{children:"name"}),e("input",{onChange:o=>f(o.target.value),type:"string",name:"name",id:"name",placeholder:"Insira aqui um valor para alterar"})]}),t("div",{children:[e("p",{children:"region"}),e("input",{onChange:o=>C(Number(o.target.value)),type:"number",name:"region",id:"region",placeholder:"Insira aqui um valor para alterar."})]}),t("div",{children:[e("p",{children:"type"}),e("input",{onChange:o=>x(o.target.value),type:"string",name:"type",id:"type",placeholder:"Insira aqui um valor para alterar."})]}),t("div",{children:[e("p",{children:"value"}),e("input",{onChange:o=>k(Number(o.target.value)),type:"number",name:"value",id:"value",placeholder:"Insira aqui um valor para alterar."})]}),t("div",{children:[e("p",{children:"pos"}),e("input",{onChange:o=>{M(o.target.value.split(",").map(Number))},type:"string",name:"pos",id:"pos",placeholder:"Insira aqui um valor para alterar."})]}),t("div",{children:[e("p",{children:"Weight"}),t("div",{className:"tooltip",children:[e("input",{onChange:o=>{o.target.value===""?D(void 0):D(Number(o.target.value))},max:I,type:"number",name:"weightStart",id:"weightStart",placeholder:"Insira aqui um valor para alterar."}),e("input",{onChange:o=>{o.target.value===""?h(void 0):h(Number(o.target.value))},min:$,type:"number",name:"weightEnd",id:"weightEnd",placeholder:"Insira aqui um valor para alterar."}),e("span",{className:"tooltiptext",children:"Insert a number from start to end, to generate a random number between them."})]})]}),e("button",{type:"submit",children:"Salvar altera\xE7\xF5es"})]})]})})}const xt=z.form`
