...
export function GraphManipulation({grapJSON}:propsGraphJson){  
  ...
  useEffect(() => {
    ...
    function CytoscapeFunctions(){
      ...
      //     return 'flat';
      //   },
      //   loopAllowed: function( node:NodeSingular ) {
      //     // for the specified node, return whether edges from itself to itself are allowed
      //     return false;
      //   },
      //   nodeLoopOffset: -50, // offset for edgeType: 'node' loops
      //   nodeParams: function( sourceNode:NodeSingular, targetNode:NodeSingular ) {
      //     // for edges between the specified source and target
      ...
      //   },
      //   complete: function( sourceNode:NodeSingular, targetNodes:NodeSingular, addedEntities: any ) {
      //     // fired when edgehandles is done and entities are added
      //   },
      //   stop: function( sourceNode:NodeSingular ) {
      //     // fired when edgehandles interaction is stopped (either complete with added edges or incomplete)
      //   }, 
      //   cancel: function( sourceNode:NodeSingular, renderedPosition: any ){
